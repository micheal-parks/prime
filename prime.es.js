...
function Fo(t) {
  ...
  return {
    ...
    p(K, P) {
      K[2] ? D ? D.p(K, P) : (D = vn(K), D.c(), D.m(n, i)) : D && (D.d(1), D = null), K[4] ? I ? I.p(K, P) : (I = kn(K), I.c(), I.m(n, null)) : I && (I.d(1), I = null), P[0] & 2 && u(a, "placeholder", K[1]), P[0] & 1 && a.value !== K[0] && (a.value = K[0]), P[0] & 8192 && c !== (c = K[13] ? !0 : void 0) && u(a, "aria-disabled", c), P[0] & 512 && h !== (h = V("py-1.5 px-1 grid place-content-center transition-transform duration-200", { "rotate-180": K[9] })) && u(d, "class", h), P[0] & 8192 && y !== (y = V("w-full border border-black", {
